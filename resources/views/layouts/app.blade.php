...
@if (!Auth::guest())
    <div class="wrapper">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <img src="imgs/logo_1.png" class="user-image" alt="User Image"/>
        ...
        <footer class="main-footer" style="max-height: 100px;text-align: center">
            <strong>Copyright © 2019 <a href="http://coopersystem.com.br/" target='_blank'>CooperSystem</a>.</strong> All rights reserved.
        </footer>
